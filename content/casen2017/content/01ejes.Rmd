...
```{r, fig-fullwidth, fig.align="center", fig.width = 10, fig.height = 2, out.width = 700, fig.fullwidth = TRUE, warning=FALSE, message=FALSE, cache=TRUE, echo = FALSE}
...
```{r, echo = FALSE, fig.width = 4, fig.heigth = 2, out.width = 300, full.width=TRUE,  warning=FALSE, message=FALSE, cache=TRUE, fig.align="center"}
...
```{r, echo = FALSE, fig.width = 5.5, fig.heigth = 2, out.width = 350, full.width=TRUE,  fig.align="center", warning=FALSE, message=FALSE, cache=TRUE}
library("dplyr")
...
```{r, echo = FALSE, fig.width = 4, fig.heigth = 2, out.width = 300, full.width=TRUE, fig.align="center", warning=FALSE, message=FALSE, cache=TRUE}
...
* [El Coeficiente de Gini](./06gini.html)
